    ...
    <div class="container"><br>
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-8 center-block" style="float: none;">
                ...
                <div class="panel panel-warning">
                    ...
                    <?php elseif ($step == 3): ?>
                        ...
                        <div class="panel-body">
                            <?php
                            if (!empty($errorMsg)) {
                                echo '<div class="alert alert-danger text-center" role="alert">' . $errorMsg . '</div><a href="javascript:history.back(-1)" class="btn btn-block btn-info"><< 返回上一页</a>';
                            } else {
                                echo '<div class="alert alert-success text-center" role="alert">数据库配置文件保存成功！</div>';
                                if ($DB->query("select * from pre_config")) {
                            ?>
                                    <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过本系统</div>
                ...
                <footer class="footer">
                    <pre><center>Powered by <a href="https://crogram.com" target="_blank">CROGRAM</a> !</center></pre>
                </footer>
            </div>
        </div>
    </div>
